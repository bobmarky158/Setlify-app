...
class _PlayScreenState extends State<PlayScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (Hive.box('settings').get('stopServiceOnPause') == true) {
      Hive.box('settings').put('stopServiceOnPause', false);
    }
    // if (Hive.box('settings').get('stopForegroundService') == true) {
    //   Hive.box('settings').put('stopForegroundService', false);
    // }
    // if (Hive.box('settings').get('stopForegroundService') == false) {
    //   Hive.box('settings').put('stopForegroundService', false);
    // }
    return Dismissible(
